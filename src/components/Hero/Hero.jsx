  ...
  return (
    <section className="lg:h-screen bg-primary-color  text-secondary-color  items-center justify-center overflow-hidden">
      ...
      <div className="lg:absolute lg:bottom-0 relative mt-1">
        <img src={heroText1} alt="Hero text-1" className="px-2 pb-4" data-aos="fade-up" data-aos-duration="1000" loading="lazy" />
        <img src={heroText1} alt="Hero text-1" className="px-2 pb-4" data-aos="fade-up" data-aos-duration="800" loading="lazy" />
        {/* <img src={heroText1} alt="Hero text-1" className="pb-4" /> */}
        <img src={heroText1} alt="Hero text-1" className="px-2 pb-9" data-aos="fade-up" data-aos-duration="600" loading="lazy" />
        ...
        <img src={heroText2} alt="Hero text-2" className="absolute bottom-0 px-2 pb-9" data-aos="fade-up" data-aos-duration="600" loading="lazy" />
